...
dataset = "NIH"
selected_model = "shufflenet_v2_x0_5_plots"
...
def train(model):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        val_acc = check_accuracy(val_loader, model) * 100
        ...
        if epoch % 10 == 0:
            ...
            log_file.write("------------------------------\n")
            log_file.write(f"Accuracy on training set: {train_acc:.2f}\n")
            log_file.write(f"Accuracy on validation set: {val_acc:.2f}%\n")
