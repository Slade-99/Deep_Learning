...
#### DWConv kernel Size of 7 ...... 2.222M params####
...
class block(nn.Module):
    def __init__(self, in_channels, intermediate_channels, identity_downsample=None, stride=1 , type='inv'):
        ...
        if(type=="inv"):
            ...
            self.conv2 = nn.Conv2d(in_channels=intermediate_channels,out_channels=intermediate_channels,kernel_size=(7, 7),stride=stride,padding = 3,groups=intermediate_channels)
