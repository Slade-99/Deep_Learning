...
#### DWConv kernel Size of 9 ...... 2.230M params####
...
class block(nn.Module):
    def __init__(self, in_channels, intermediate_channels, identity_downsample=None, stride=1 , type='inv'):
        ...
        if(type=="inv"):
            ...
            self.conv2 = nn.Conv2d(in_channels=intermediate_channels,out_channels=intermediate_channels,kernel_size=(9, 9),stride=stride,padding = 4,groups=intermediate_channels)
