...
class AugmentedDataset(Dataset):
    def __init__(self, dataset, augmentations=None):
        ...
        # Define augmentations (example for 'val' and 'aug')
        if augmentations == 'val':
            self.augmentations = val_transform  # Define your validation transforms
        elif augmentations == 'aug':
            self.augmentations = aug_transform  # Define your augmentation transforms
        else:
