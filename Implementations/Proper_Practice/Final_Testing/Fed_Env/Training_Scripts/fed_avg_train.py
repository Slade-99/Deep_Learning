...
name = "Fed_avg_Custom_Architecture"
...
def train_local_model(local_model, dataloader, num_epochs, criterion, optimizer):
    local_model.train()
...
for round_num in range(num_rounds):
    ...
    for client_id in selected_clients:
        ...
        local_weights = train_local_model(local_model, client_dataloaders[client_id], num_epochs, criterion, optimizer)
