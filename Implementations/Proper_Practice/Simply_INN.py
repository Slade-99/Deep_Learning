...
class INN(nn.Module):
    def __init__(self, in_channels=1, num_classes=3):
        ...
        self.inv1 = Involution(in_channels, 3, kernel_size=(3, 3), stride=(1, 1), groups=1)
        
        
        
        self.inv2 = Involution(3, 3, kernel_size=(5, 5), stride=(1, 1), groups=1)
        
        
        
        self.inv3 = Involution(3, 3, kernel_size=(7, 7), stride=(1, 1), groups=1)
