...
def save_checkpoint(state, filename="/home/azwad/Works/DL_Models_Checkpoint/Inception.pth.tar"):
...
# Initialize network
model = Inception(in_channels=in_channels, num_classes=num_classes).to(device)
