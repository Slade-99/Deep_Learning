...
### Architecture ###
#EdgeViT
## https://github.com/1hunters/EdgeViT/blob/main/edgevit.py
import torch
...
class EdgeViT(nn.Module):
    def __init__(self, channels, blocks, heads, r=[4, 2, 2, 1], num_classes=3, distillation=False):
        super().__init__()
        ...
        self.target_layer = self.main_body[-1].module.mlp_layer_1
...
#summary(edgevit, input_size =(1,224,224))
