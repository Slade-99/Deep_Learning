...
test_dir = '/home/azwad/Downloads/For Running/test/'
log_file_name = "Federated Learning Training Log for EfficientNetB0\n"
log_file_path = "training_logs_EfficientNetB0.txt"
train_paths = []
train_labels = []
test_paths = []
test_labels = []
...
for round_num in range(NUM_ROUNDS):
    ...
    model_save_path = 'saved_model/EfficientNetB0.h5'
...
model_save_path = '/home/azwad/Works/Deep_Learning/Statistics/EfficientNetB0/EfficientNetB0.h5'
loaded_model = tf.keras.models.load_model(model_save_path)
